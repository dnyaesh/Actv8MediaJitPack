...
/**
 * Created by neoforce-01 on 9/3/2018.
 */

public class GetAndroidPassById extends AsyncTask<String, String, Void>
{
    ...
    protected Void doInBackground(String... params)
    {
        ...
        try
        {
            ...
            response = Actv8AsyncTask.actv8ServerRequest(Actv8MediaCoreLibrary.getInstance().getBaseUrl() + "user/"+userId+"/content/"+contentId+"/androidpass/", "GET", null);
        }
    ...
    protected void onPostExecute(Void aVoid)
    {
        ...
        Actv8MediaCoreLibrary.getInstance().onAndroidPassByIdResponse(response);
    }
}